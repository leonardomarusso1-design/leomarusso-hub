...
export const ebooks: Ebook[] = [
  ...
  },
  {
    ...
    description:
      "A ferramenta que acompanha o ebook 'Do Zero à Primeira Oferta': uma central com 50 prompts premium, checklist de execução, modelo de oferta preenchível, mensagens de WhatsApp prontas para cada etapa da venda, modelo de precificação e uma planilha de CRM em Excel para organizar sua prospecção.",
    price: 0,
    priceLabel: "Ver na Kiwify",
    color: "teal",
    chapters: [
      "50 Prompts Premium (diagnóstico de oportunidades locais, criação de oferta, plaquinhas QR/NFC, fotos com IA, biosites e sites, WhatsApp e vendas)",
    ...
    faq: [
      { q: "É um ebook ou uma ferramenta?", a: "É uma área protegida por senha (entregue pela Kiwify após a compra), não um PDF — os prompts, mensagens e a planilha ficam acessíveis para copiar quando precisar." },
